...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/csquotes.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/csquotes.doc.tar.xz

Name: texlive-csquotes
License: LPPL
Summary: Context sensitive quotation facilities
Version: %{tl_version}
Release: %{tl_noarch_release}.5.0a.svn18877%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/csquotes/csq-compat.def
%{_texdir}/texmf-dist/tex/latex/csquotes/csquotes.cfg
%{_texdir}/texmf-dist/tex/latex/csquotes/csquotes.def
%{_texdir}/texmf-dist/tex/latex/csquotes/csquotes.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/csquotes/README
%{_texdir}/texmf-dist/doc/latex/csquotes/RELEASE
%{_texdir}/texmf-dist/doc/latex/csquotes/csquotes.pdf
%{_texdir}/texmf-dist/doc/latex/csquotes/csquotes.tex
