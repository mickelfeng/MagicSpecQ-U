...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/url.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/url.doc.tar.xz

Name: texlive-url
License: LPPL
Summary: Verbatim with URL-sensitive line breaks
Version: %{tl_version}
Release: %{tl_noarch_release}.3.2.svn16864%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/url/url.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/url/miscdoc.sty
%{_texdir}/texmf-dist/doc/latex/url/url.pdf
%{_texdir}/texmf-dist/doc/latex/url/url.tex
