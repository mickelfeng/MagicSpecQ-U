...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/currfile.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/currfile.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/currfile.source.tar.xz

Name: texlive-currfile
License: LPPL
Summary: Macros for file name and path of input files
Version: %{tl_version}
Release: %{tl_noarch_release}.0.1.svn17776%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/currfile/currfile.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/currfile/README
%{_texdir}/texmf-dist/doc/latex/currfile/currfile.pdf
