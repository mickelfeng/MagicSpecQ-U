...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/mhequ.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/mhequ.doc.tar.xz

Name: texlive-mhequ
License: Freely redistributable without restriction
Summary: Multicolumn equations, tags, labels, sub-numbering
Version: %{tl_version}
Release: %{tl_noarch_release}.1.61.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/tex/latex/mhequ/mhequ.sty

%files doc
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/doc/latex/mhequ/example.pdf
%{_texdir}/texmf-dist/doc/latex/mhequ/example.tex
