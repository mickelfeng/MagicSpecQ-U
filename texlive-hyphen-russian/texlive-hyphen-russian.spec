...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/hyphen-russian.tar.xz

Name: texlive-hyphen-russian
License: LPPL
Summary: hyphen-russian package
Version: %{tl_version}
...
%postun
if [ $1 == 0 ]; then
  sed -i '/russian loadhyph-ru.tex/d' %{_texdir}/texmf/tex/generic/config/language.dat
  sed -i '/\\addlanguage{russian}{loadhyph-ru.tex}{}{2}{2}/d' %{_texdir}/texmf/tex/generic/config/language.def
