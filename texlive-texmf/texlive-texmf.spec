...
Obsoletes:	texlive-texmf-errata-afm = %{version}
...
Requires:	texlive-texmf = %{version}-%{release}
Obsoletes:	texlive-texmf-errata-dvips = %{version}
...
Obsoletes:	texlive-texmf-errata-fonts = %{version}
...
Requires:	texlive-texmf = %{version}-%{release}
Obsoletes:	texlive-texmf-errata-latex = %{version}
...
Requires:	texlive-texmf = %{version}-%{release}
Obsoletes:	texlive-texmf-errata-xetex = %{version}
...
%changelog
* Sat Jan 14 2012 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 2007-41
- Rebuilt for https://fedoraproject.org/wiki/Fedora_17_Mass_Rebuild

* Mon Nov  7 2011 Tom Callaway <spot@fedoraproject.org> 2007-40
- add inconsolata for R

* Thu Sep 21 2011 Jindrich Novy <jnovy@redhat.com> 2007-39
- fix CMAPFONTS -> point to poppler path (#736242)

* Tue Jul 26 2011 Jindrich Novy <jnovy@redhat.com> 2007-38
...
* Wed Feb 09 2011 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 2007-37
- Rebuilt for https://fedoraproject.org/wiki/Fedora_15_Mass_Rebuild

* Thu Jul  8 2010 Jindrich Novy <jnovy@redhat.com> 2007-36
- obsolete *-errata packages, they were never really used

* Tue Jan  5 2010 Jindrich Novy <jnovy@redhat.com> 2007-35
