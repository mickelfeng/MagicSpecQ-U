...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/geometry.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/geometry.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/geometry.source.tar.xz

Name: texlive-geometry
License: LPPL
Summary: Flexible and complete interface to document dimensions
Version: %{tl_version}
Release: %{tl_noarch_release}.5.5.svn19448%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/geometry/geometry.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/geometry/README
%{_texdir}/texmf-dist/doc/latex/geometry/changes.txt
%{_texdir}/texmf-dist/doc/latex/geometry/geometry-samples.tex
%{_texdir}/texmf-dist/doc/latex/geometry/geometry.cfg
%{_texdir}/texmf-dist/doc/latex/geometry/geometry.pdf
