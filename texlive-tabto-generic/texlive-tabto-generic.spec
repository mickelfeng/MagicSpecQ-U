...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/tabto-generic.tar.xz
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/generic/tabto-generic/tabto.tex
