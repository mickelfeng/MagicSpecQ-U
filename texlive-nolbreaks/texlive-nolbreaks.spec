...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/nolbreaks.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/nolbreaks.doc.tar.xz

Name: texlive-nolbreaks
License: Public Domain
Summary: No line breaks in text
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.svn18127%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/nolbreaks/nolbreaks.sty

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/latex/nolbreaks/nolbreaks.pdf
%{_texdir}/texmf-dist/doc/latex/nolbreaks/nolbreaks.tex
