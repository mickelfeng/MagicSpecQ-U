...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/datatool.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/datatool.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/datatool.source.tar.xz

Name: texlive-datatool
License: LPPL
Summary: Tools to load and manipulate data
Version: %{tl_version}
Release: %{tl_noarch_release}.2.03.svn16023%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/bibtex/bst/datatool/databib.bst
%{_texdir}/texmf-dist/tex/latex/datatool/databar.sty
%{_texdir}/texmf-dist/tex/latex/datatool/databib.sty
%{_texdir}/texmf-dist/tex/latex/datatool/datapie.sty
%{_texdir}/texmf-dist/tex/latex/datatool/dataplot.sty
%{_texdir}/texmf-dist/tex/latex/datatool/datatool.sty
%{_texdir}/texmf-dist/tex/latex/datatool/person.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/datatool/CHANGES
%{_texdir}/texmf-dist/doc/latex/datatool/README
%{_texdir}/texmf-dist/doc/latex/datatool/datatool.pdf
