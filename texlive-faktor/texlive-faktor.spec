...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/faktor.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/faktor.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/faktor.source.tar.xz

Name: texlive-faktor
License: LPPL
Summary: Typeset quotient structures with LaTeX
Version: %{tl_version}
Release: %{tl_noarch_release}.0.1b.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/faktor/faktor.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/faktor/README
%{_texdir}/texmf-dist/doc/latex/faktor/faktor.pdf
