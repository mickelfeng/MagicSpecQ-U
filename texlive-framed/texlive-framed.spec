...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/framed.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/framed.doc.tar.xz

Name: texlive-framed
License: Freely redistributable without restriction
Summary: Framed or shaded regions that can break across pages
Version: %{tl_version}
Release: %{tl_noarch_release}.0.95.svn17274%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/tex/latex/framed/framed.sty

%files doc
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/doc/latex/framed/framed.pdf
%{_texdir}/texmf-dist/doc/latex/framed/framed.tex
