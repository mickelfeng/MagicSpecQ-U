...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/captdef.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/captdef.doc.tar.xz

Name: texlive-captdef
License: LPPL
Summary: Declare free-standing \caption commands
Version: %{tl_version}
Release: %{tl_noarch_release}.svn17353%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/captdef/captdef.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/captdef/captdef.pdf
%{_texdir}/texmf-dist/doc/latex/captdef/captdef.tex
%{_texdir}/texmf-dist/doc/latex/captdef/miscdoc.sty
