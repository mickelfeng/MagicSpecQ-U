...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gastex.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gastex.doc.tar.xz

Name: texlive-gastex
License: LPPL
Summary: Graphs and Automata Simplified in TeX
Version: %{tl_version}
Release: %{tl_noarch_release}.2.8.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/dvips/gastex/gastex.pro
%{_texdir}/texmf-dist/tex/latex/gastex/gastex.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/gastex/README
%{_texdir}/texmf-dist/doc/latex/gastex/ex-beamer-gastex.tex
%{_texdir}/texmf-dist/doc/latex/gastex/ex-gastex.tex
