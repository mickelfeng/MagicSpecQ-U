...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ulqda.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ulqda.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ulqda.source.tar.xz

Name: texlive-ulqda
License: LPPL
Summary: Support of Qualitative Data Analysis
Version: %{tl_version}
Release: %{tl_noarch_release}.1.1.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-ulqda-bin = %{tl_version}
Provides: tex(ulqda.sty)
...
%package doc
Summary: Documentation for ulqda
Version: %{tl_version}
Release: %{tl_noarch_release}.1.1.svn18835%{?dist}
Requires: texlive-base = %{tl_version}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/scripts/ulqda/ulqda.pl
%{_texdir}/texmf-dist/tex/latex/ulqda/ulqda.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/ulqda/README
%{_texdir}/texmf-dist/doc/latex/ulqda/ulqda.pdf
