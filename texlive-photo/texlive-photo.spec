...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/photo.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/photo.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/photo.source.tar.xz

Name: texlive-photo
License: LPPL
Summary: A float environment for photographs
Version: %{tl_version}
Release: %{tl_noarch_release}.svn18739%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/photo/photo.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/photo/Makefile
%{_texdir}/texmf-dist/doc/latex/photo/photo.pdf
%{_texdir}/texmf-dist/doc/latex/photo/photo_test.tex
