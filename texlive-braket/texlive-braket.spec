...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/braket.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/braket.doc.tar.xz

Name: texlive-braket
License: Public Domain
Summary: Dirac bra-ket and set notations
Version: %{tl_version}
Release: %{tl_noarch_release}.svn17127%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/braket/braket.sty

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/latex/braket/braket.pdf
%{_texdir}/texmf-dist/doc/latex/braket/braket.tex
