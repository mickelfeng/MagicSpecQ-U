...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/philex.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/philex.doc.tar.xz

Name: texlive-philex
License: LPPL
Summary: Cross references for named and numbered environments
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.svn17879%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/philex/philex.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/philex/philexmanualb.pdf
%{_texdir}/texmf-dist/doc/latex/philex/philexmanualb.tex
