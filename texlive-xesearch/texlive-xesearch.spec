...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/xesearch.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/xesearch.doc.tar.xz

Name: texlive-xesearch
License: LPPL
Summary: A string finder for XeTeX
Version: %{tl_version}
Release: %{tl_noarch_release}.svn16041%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/xetex/xesearch/t-xesearch.tex
%{_texdir}/texmf-dist/tex/xetex/xesearch/xesearch.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/xetex/xesearch/README
%{_texdir}/texmf-dist/doc/xetex/xesearch/xesearch.pdf
%{_texdir}/texmf-dist/doc/xetex/xesearch/xesearch.tex
