...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/mptopdf.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/mptopdf.doc.tar.xz
...
Requires: texlive-mptopdf-bin = %{tl_version}
...
sed -i 's/^\#\!\ mptopdf/mptopdf pdftex - -translate-file=cp227.tcx mptopdf.tex/' %{_texdir}/texmf/web2c/fmtutil.cnf
touch /var/run/texlive/run-fmtutil
:

%postun
if [ $1 == 0 ]; then
  sed -i 's/^mptopdf/\#\!\ mptopdf/' %{_texdir}/texmf/web2c/fmtutil.cnf
...
%{_texdir}/texmf-dist/tex/context/base/supp-mis.mkii
%{_texdir}/texmf-dist/tex/context/base/supp-mpe.mkii
%{_texdir}/texmf-dist/tex/context/base/supp-pdf.mkii
%{_texdir}/texmf-dist/tex/context/base/syst-tex.mkii
%{_texdir}/texmf-dist/tex/generic/context/mptopdf.tex
