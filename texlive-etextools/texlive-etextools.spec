...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/etextools.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/etextools.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/etextools.source.tar.xz

Name: texlive-etextools
License: LPPL
Summary: e-TeX tools for LaTeX users and package writers
Version: %{tl_version}
Release: %{tl_noarch_release}.3.14159.svn17928%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/etextools/etextools.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/etextools/README
%{_texdir}/texmf-dist/doc/latex/etextools/etextools-examples.pdf
%{_texdir}/texmf-dist/doc/latex/etextools/etextools-examples.tex
%{_texdir}/texmf-dist/doc/latex/etextools/etextools.pdf
