...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/bundledoc.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/bundledoc.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/bundledoc.doc.tar.xz

Name: texlive-bundledoc
License: LPPL
Summary: Bundle together all the files needed to build a LaTeX document
Version: %{tl_version}
Release: %{tl_noarch_release}.3.0.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-bundledoc-bin = %{tl_version}
...
%package doc
Summary: Documentation for bundledoc
Version: %{tl_version}
Release: %{tl_noarch_release}.3.0.svn18835%{?dist}
Requires: texlive-base = %{tl_version}
BuildArch: noarch
...
%{_texdir}/texmf-dist/scripts/bundledoc/arlatex
%{_texdir}/texmf-dist/scripts/bundledoc/bundledoc
%{_texdir}/texmf-dist/tex/latex/bundledoc/miktex.cfg
%{_texdir}/texmf-dist/tex/latex/bundledoc/texlive-unix.cfg

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/support/bundledoc/README
