...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/bibtex8.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/bibtex8.doc.tar.xz

Name: texlive-bibtex8
License: GPL+
Summary: A fully 8-bit adaptation of BibTeX 0.99
Version: %{tl_version}
Release: %{tl_noarch_release}.3.71.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-bibtex8-bin = %{tl_version}
...
%package doc
Summary: Documentation for bibtex8
Version: %{tl_version}
Release: %{tl_noarch_release}.3.71.svn18835%{?dist}
Requires: texlive-base = %{tl_version}
BuildArch: noarch
...
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf/doc/bibtex8/00readme.txt
%{_texdir}/texmf/doc/bibtex8/HISTORY
%{_texdir}/texmf/doc/bibtex8/csfile.txt
%{_texdir}/texmf/doc/bibtex8/file_id.diz
