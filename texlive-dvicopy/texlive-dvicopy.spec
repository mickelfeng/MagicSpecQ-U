...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dvicopy.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dvicopy.doc.tar.xz

Name: texlive-dvicopy
License: GPL+
Summary: Copy DVI files, flattening VFs
Version: %{tl_version}
Release: %{tl_noarch_release}.1.5.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-dvicopy-bin = %{tl_version}
