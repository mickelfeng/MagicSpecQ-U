...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/rccol.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/rccol.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/rccol.source.tar.xz

Name: texlive-rccol
License: Freely redistributable without restriction
Summary: Decimal-centered optionally rounded numbers in tabular
Version: %{tl_version}
Release: %{tl_noarch_release}.1.2c.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/tex/latex/rccol/rccol.sty

%files doc
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/doc/latex/rccol/README
%{_texdir}/texmf-dist/doc/latex/rccol/rccol.pdf
