...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/thumby.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/thumby.doc.tar.xz

Name: texlive-thumby
License: GPLv3+
Summary: Create thumb indexes for printed books
Version: %{tl_version}
Release: %{tl_noarch_release}.0.1.svn16736%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc gpl3.txt
%{_texdir}/texmf-dist/tex/latex/thumby/thumby.sty

%files doc
%defattr(-,root,root)
%doc gpl3.txt
%{_texdir}/texmf-dist/doc/latex/thumby/LICENSE
%{_texdir}/texmf-dist/doc/latex/thumby/README
%{_texdir}/texmf-dist/doc/latex/thumby/example.pdf
%{_texdir}/texmf-dist/doc/latex/thumby/latexmkrc
%{_texdir}/texmf-dist/doc/latex/thumby/thumby.pdf
