...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/isonums.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/isonums.doc.tar.xz

Name: texlive-isonums
License: LPPL
Summary: Display numbers in maths mode according to ISO 31-0
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.svn17362%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/isonums/isonums.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/isonums/isonums.pdf
%{_texdir}/texmf-dist/doc/latex/isonums/isonums.tex
