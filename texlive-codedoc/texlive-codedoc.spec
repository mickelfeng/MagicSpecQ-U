...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/codedoc.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/codedoc.doc.tar.xz

Name: texlive-codedoc
License: LPPL
Summary: LaTeX code and documentation in LaTeX-format file
Version: %{tl_version}
Release: %{tl_noarch_release}.0.3.svn17630%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Provides: tex(codedoc.sty)
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/codedoc/codedoc.cls

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/codedoc/CodeDoc-manual.pdf
%{_texdir}/texmf-dist/doc/latex/codedoc/CodeDoc-manual.tex
%{_texdir}/texmf-dist/doc/latex/codedoc/README
