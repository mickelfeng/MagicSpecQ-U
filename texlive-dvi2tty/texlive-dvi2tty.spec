...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dvi2tty.tar.xz

Name: texlive-dvi2tty
License: GPL+
Summary: Produce ASCII from DVI
Version: %{tl_version}
Release: %{tl_noarch_release}.3.5.1.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-dvi2tty-bin = %{tl_version}
