...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dpfloat.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dpfloat.doc.tar.xz

Name: texlive-dpfloat
License: LPPL
Summary: Support for double-page floats
Version: %{tl_version}
Release: %{tl_noarch_release}.svn17196%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/dpfloat/dpfloat.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/dpfloat/README
%{_texdir}/texmf-dist/doc/latex/dpfloat/dpfloat.pdf
%{_texdir}/texmf-dist/doc/latex/dpfloat/dpfloat.tex
