...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gmverb.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gmverb.doc.tar.xz

Name: texlive-gmverb
License: LPPL
Summary: A variant of LaTeX \verb, verbatim and shortvrb
Version: %{tl_version}
Release: %{tl_noarch_release}.v0.91.svn17344%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/gmverb/gmverb.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/gmverb/README
%{_texdir}/texmf-dist/doc/latex/gmverb/gmverb.pdf
