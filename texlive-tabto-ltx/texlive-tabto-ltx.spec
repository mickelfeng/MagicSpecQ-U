...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/tabto-ltx.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/tabto-ltx.doc.tar.xz

Name: texlive-tabto-ltx
License: LPPL
Summary: "Tab" to a measured position in the line
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.svn18159%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Provides: tex(tabto.sty)
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/tabto-ltx/tabto.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/tabto-ltx/tabto-doc.pdf
%{_texdir}/texmf-dist/doc/latex/tabto-ltx/tabto-doc.tex
%{_texdir}/texmf-dist/doc/latex/tabto-ltx/tabto.txt
