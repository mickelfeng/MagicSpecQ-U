...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/iftex.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/iftex.doc.tar.xz

Name: texlive-iftex
License: LPPL
Summary: Am I running under pdfTeX, XeTeX or LuaTeX?
Version: %{tl_version}
Release: %{tl_noarch_release}.0.2.svn18833%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/generic/iftex/iftex.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/generic/iftex/README
%{_texdir}/texmf-dist/doc/generic/iftex/iftex.pdf
%{_texdir}/texmf-dist/doc/generic/iftex/iftex.tex
