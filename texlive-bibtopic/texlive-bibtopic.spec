...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/bibtopic.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/bibtopic.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/bibtopic.source.tar.xz

Name: texlive-bibtopic
License: GPL+
Summary: Include multiple bibliographies in a document
Version: %{tl_version}
Release: %{tl_noarch_release}.1.1a.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/tex/latex/bibtopic/bibtopic.sty

%files doc
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/doc/latex/bibtopic/README
%{_texdir}/texmf-dist/doc/latex/bibtopic/articles.bib
%{_texdir}/texmf-dist/doc/latex/bibtopic/bibtopic.pdf
%{_texdir}/texmf-dist/doc/latex/bibtopic/books.bib
%{_texdir}/texmf-dist/doc/latex/bibtopic/sample.tex
