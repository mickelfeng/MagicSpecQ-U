...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/web.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/web.doc.tar.xz

Name: texlive-web
License: Knuth
Summary: original web programs tangle and weave
Version: %{tl_version}
Release: %{tl_noarch_release}.4.5.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-kpathsea = %{tl_version}
Requires: texlive-web-bin = %{tl_version}
