...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/toolbox.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/toolbox.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/toolbox.source.tar.xz

Name: texlive-toolbox
License: LPPL
Summary: Macros for writing indices, glossaries
Version: %{tl_version}
Release: %{tl_noarch_release}.5.1.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/toolbox/toolbox.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/toolbox/README
%{_texdir}/texmf-dist/doc/latex/toolbox/toolbox.tex
%{_texdir}/texmf-dist/doc/latex/toolbox/toolbox.txt
