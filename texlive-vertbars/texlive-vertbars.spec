...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/vertbars.tar.xz
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/vertbars/vertbars.sty
