...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/12many.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/12many.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/12many.source.tar.xz
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/12many/12many.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/12many/12many.pdf
%{_texdir}/texmf-dist/doc/latex/12many/README
