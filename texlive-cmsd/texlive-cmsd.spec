...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/cmsd.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/cmsd.doc.tar.xz

Name: texlive-cmsd
License: LPPL
Summary: Interfaces to the CM Sans Serif Bold fonts
Version: %{tl_version}
Release: %{tl_noarch_release}.svn18787%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/cmsd/cmsd.sty
%{_texdir}/texmf-dist/tex/latex/cmsd/t1cmsd.fd
%{_texdir}/texmf-dist/tex/latex/cmsd/ts1cmsd.fd

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/cmsd/liesmich
%{_texdir}/texmf-dist/doc/latex/cmsd/readme
