...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/blindtext.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/blindtext.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/blindtext.source.tar.xz

Name: texlive-blindtext
License: LPPL
Summary: Producing 'blind' text for testing
Version: %{tl_version}
Release: %{tl_noarch_release}.1.9c.svn16623%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/blindtext/blindtext.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/blindtext/README
%{_texdir}/texmf-dist/doc/latex/blindtext/blindtext.pdf
