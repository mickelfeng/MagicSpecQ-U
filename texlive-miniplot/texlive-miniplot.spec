...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/miniplot.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/miniplot.doc.tar.xz

Name: texlive-miniplot
License: LPPL
Summary: A package for easy figure arrangement
Version: %{tl_version}
Release: %{tl_noarch_release}.svn17483%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/miniplot/miniplot.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/miniplot/disclaimer.txt
%{_texdir}/texmf-dist/doc/latex/miniplot/documentation.zip
%{_texdir}/texmf-dist/doc/latex/miniplot/miniplot.pdf
%{_texdir}/texmf-dist/doc/latex/miniplot/miniplot.tex
