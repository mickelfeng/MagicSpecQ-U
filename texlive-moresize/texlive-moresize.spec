...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/moresize.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/moresize.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/moresize.source.tar.xz

Name: texlive-moresize
License: LPPL
Summary: Allows font sizes up to 35.83pt
Version: %{tl_version}
Release: %{tl_noarch_release}.1.9.svn17513%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/moresize/moresize.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/moresize/moresize.pdf
%{_texdir}/texmf-dist/doc/latex/moresize/moresize.upl
%{_texdir}/texmf-dist/doc/latex/moresize/msizetst.tex
