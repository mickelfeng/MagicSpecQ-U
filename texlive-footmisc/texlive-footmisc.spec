...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/footmisc.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/footmisc.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/footmisc.source.tar.xz

Name: texlive-footmisc
License: LPPL
Summary: A range of footnote options
Version: %{tl_version}
Release: %{tl_noarch_release}.5.5a.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/footmisc/footmisc.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/footmisc/README
%{_texdir}/texmf-dist/doc/latex/footmisc/footmisc.pdf
