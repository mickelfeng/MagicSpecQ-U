...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/figsize.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/figsize.doc.tar.xz

Name: texlive-figsize
License: LPPL
Summary: Auto-size graphics
Version: %{tl_version}
Release: %{tl_noarch_release}.0.1.svn18784%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/figsize/figsize.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/figsize/README
%{_texdir}/texmf-dist/doc/latex/figsize/epsfig.eps
%{_texdir}/texmf-dist/doc/latex/figsize/figsize.pdf
%{_texdir}/texmf-dist/doc/latex/figsize/figsize.tex
