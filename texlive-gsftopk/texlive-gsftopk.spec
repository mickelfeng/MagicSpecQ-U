...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gsftopk.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gsftopk.doc.tar.xz

Name: texlive-gsftopk
License: GPL+
Summary: Convert "ghostscript fonts" to PK files
Version: %{tl_version}
Release: %{tl_noarch_release}.1.19.2.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-gsftopk-bin = %{tl_version}
...
%{_texdir}/texmf/dvips/gsftopk/render.ps
