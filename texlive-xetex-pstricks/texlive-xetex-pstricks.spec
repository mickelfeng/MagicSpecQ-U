...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/xetex-pstricks.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/xetex-pstricks.doc.tar.xz

Name: texlive-xetex-pstricks
License: Public Domain
Summary: Running PStricks under XeTeX
Version: %{tl_version}
Release: %{tl_noarch_release}.svn17055%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/xelatex/xetex-pstricks/pstricks.con
%{_texdir}/texmf-dist/tex/xetex/xetex-pstricks/pstricks.con

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/xetex/xetex-pstricks/README
