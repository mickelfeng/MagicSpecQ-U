...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/accfonts.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/accfonts.doc.tar.xz

Name: texlive-accfonts
License: GPL+
Summary: Utilities to derive new fonts from existing ones
Version: %{tl_version}
Release: %{tl_noarch_release}.0.25.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-accfonts-bin = %{tl_version}
...
%package doc
Summary: Documentation for accfonts
Version: %{tl_version}
Release: %{tl_noarch_release}.0.25.svn18835%{?dist}
Requires: texlive-base = %{tl_version}
BuildArch: noarch
...
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/scripts/accfonts/mkt1font
%{_texdir}/texmf-dist/scripts/accfonts/vpl2ovp
%{_texdir}/texmf-dist/scripts/accfonts/vpl2vpl
%{_texdir}/texmf-dist/tex/latex/accfonts/CSX.def
%{_texdir}/texmf-dist/tex/latex/accfonts/ISO-Latin1.def
%{_texdir}/texmf-dist/tex/latex/accfonts/ISO-Latin2.def
%{_texdir}/texmf-dist/tex/latex/accfonts/IndUni_Omega.def
%{_texdir}/texmf-dist/tex/latex/accfonts/Norman.def

%files doc
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/doc/fonts/accfonts/CHANGES
%{_texdir}/texmf-dist/doc/fonts/accfonts/COPYING
%{_texdir}/texmf-dist/doc/fonts/accfonts/README
