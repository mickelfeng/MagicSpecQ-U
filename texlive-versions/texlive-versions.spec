...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/versions.tar.xz

Name: texlive-versions
License: LPPL
Summary: Optionally omit pieces of text
Version: %{tl_version}
Release: %{tl_noarch_release}.0.55.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/versions/versions.sty
