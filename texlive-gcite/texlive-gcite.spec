...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gcite.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gcite.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gcite.source.tar.xz

Name: texlive-gcite
License: LPPL
Summary: Citations in a reader-friendly style
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.1.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/gcite/gcite.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/gcite/CHANGES
%{_texdir}/texmf-dist/doc/latex/gcite/README
%{_texdir}/texmf-dist/doc/latex/gcite/gcite.bib
%{_texdir}/texmf-dist/doc/latex/gcite/gcite.pdf
