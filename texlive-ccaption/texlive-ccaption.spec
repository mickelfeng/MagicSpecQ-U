...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ccaption.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ccaption.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ccaption.source.tar.xz

Name: texlive-ccaption
License: LPPL
Summary: Continuation headings and legends for floats
Version: %{tl_version}
Release: %{tl_noarch_release}.3.2b.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/ccaption/ccaption.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/ccaption/README
%{_texdir}/texmf-dist/doc/latex/ccaption/ccaption.pdf
