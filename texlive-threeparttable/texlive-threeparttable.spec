...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/threeparttable.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/threeparttable.doc.tar.xz

Name: texlive-threeparttable
License: Freely redistributable without restriction
Summary: Tables with captions and notes all the same width
Version: %{tl_version}
Release: %{tl_noarch_release}.svn17383%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/tex/latex/threeparttable/3parttable.sty
%{_texdir}/texmf-dist/tex/latex/threeparttable/threeparttable.sty

%files doc
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/doc/latex/threeparttable/miscdoc.sty
%{_texdir}/texmf-dist/doc/latex/threeparttable/threeparttable.pdf
%{_texdir}/texmf-dist/doc/latex/threeparttable/threeparttable.tex
