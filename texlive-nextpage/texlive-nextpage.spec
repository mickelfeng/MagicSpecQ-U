...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/nextpage.tar.xz
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/nextpage/nextpage.sty
