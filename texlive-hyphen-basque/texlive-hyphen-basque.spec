...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/hyphen-basque.tar.xz

Name: texlive-hyphen-basque
License: Freely redistributable without restriction
Summary: Hyphenation for Basque
Version: %{tl_version}
...
echo "basque loadhyph-eu.tex" >> %{_texdir}/texmf/tex/generic/config/language.dat
echo "\addlanguage{basque}{loadhyph-eu.tex}{}{2}{2}" >> %{_texdir}/texmf/tex/generic/config/language.def
touch /var/run/texlive/run-fmtutil
:

%postun
if [ $1 == 0 ]; then
  sed -i '/basque loadhyph-eu.tex/d' %{_texdir}/texmf/tex/generic/config/language.dat
  sed -i '/\\addlanguage{basque}{loadhyph-eu.tex}{}{2}{2}/d' %{_texdir}/texmf/tex/generic/config/language.def
