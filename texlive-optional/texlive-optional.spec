...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/optional.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/optional.doc.tar.xz

Name: texlive-optional
License: LPPL
Summary: Facilitate optional printing of parts of a document
Version: %{tl_version}
Release: %{tl_noarch_release}.2.2b.svn18131%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/optional/optional.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/optional/optional.pdf
%{_texdir}/texmf-dist/doc/latex/optional/optional.tex
