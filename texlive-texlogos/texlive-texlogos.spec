...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/texlogos.tar.xz

Name: texlive-texlogos
License: LPPL
Summary: Ready-to-use LaTeX logos
Version: %{tl_version}
Release: %{tl_noarch_release}.1.3.1.svn19083%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/texlogos/texlogos.sty
