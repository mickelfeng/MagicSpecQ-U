...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/fixpdfmag.tar.xz
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/plain/fixpdfmag/fixpdfmag.tex
