...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/tie.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/tie.doc.tar.xz

Name: texlive-tie
License: Freely redistributable without restriction
Summary: Allow multiple web change files
Version: %{tl_version}
Release: %{tl_noarch_release}.2.4.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-kpathsea = %{tl_version}
Requires: texlive-tie-bin = %{tl_version}
