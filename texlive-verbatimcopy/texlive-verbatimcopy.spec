...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/verbatimcopy.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/verbatimcopy.doc.tar.xz

Name: texlive-verbatimcopy
License: LPPL
Summary: Make copies of text documents from within LaTeX
Version: %{tl_version}
Release: %{tl_noarch_release}.0.06.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/verbatimcopy/verbatimcopy.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/verbatimcopy/README
%{_texdir}/texmf-dist/doc/latex/verbatimcopy/verbatimcopy.pdf
%{_texdir}/texmf-dist/doc/latex/verbatimcopy/verbatimcopy.tex
