...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/euler.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/euler.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/euler.source.tar.xz

Name: texlive-euler
License: LPPL
Summary: Use AMS Euler fonts for math
Version: %{tl_version}
Release: %{tl_noarch_release}.2.5.svn17261%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/euler/euler.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/euler/euler.pdf
%{_texdir}/texmf-dist/doc/latex/euler/legal.txt
