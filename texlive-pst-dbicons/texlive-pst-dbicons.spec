...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/pst-dbicons.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/pst-dbicons.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/pst-dbicons.source.tar.xz

Name: texlive-pst-dbicons
License: LPPL
Summary: Support for drawing ER diagrams
Version: %{tl_version}
Release: %{tl_noarch_release}.0.16.svn17556%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/pst-dbicons/pst-dbicons.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/generic/pst-dbicons/README
%{_texdir}/texmf-dist/doc/generic/pst-dbicons/mondial-ER.tex
%{_texdir}/texmf-dist/doc/generic/pst-dbicons/pst-dbicons.pdf
