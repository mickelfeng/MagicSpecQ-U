...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/drs.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/drs.doc.tar.xz

Name: texlive-drs
License: LPPL
Summary: Typeset Discourse Representation Structures (DRS)
Version: %{tl_version}
Release: %{tl_noarch_release}.1.1b.svn19232%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/drs/drs.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/drs/README
%{_texdir}/texmf-dist/doc/latex/drs/drsdoc.pdf
%{_texdir}/texmf-dist/doc/latex/drs/drsdoc.tex
