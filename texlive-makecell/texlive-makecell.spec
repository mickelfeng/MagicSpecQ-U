...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/makecell.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/makecell.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/makecell.source.tar.xz

Name: texlive-makecell
License: LPPL
Summary: Tabular column heads and multilined cells
Version: %{tl_version}
Release: %{tl_noarch_release}.0.1e.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/makecell/makecell.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/makecell/README
%{_texdir}/texmf-dist/doc/latex/makecell/makecell-rus.pdf
%{_texdir}/texmf-dist/doc/latex/makecell/makecell-rus.tex
%{_texdir}/texmf-dist/doc/latex/makecell/makecell.pdf
