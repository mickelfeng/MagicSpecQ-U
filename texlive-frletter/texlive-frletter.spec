...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/frletter.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/frletter.doc.tar.xz
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/frletter/frletter.cls

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/latex/frletter/README
