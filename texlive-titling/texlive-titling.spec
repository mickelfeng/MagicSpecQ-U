...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/titling.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/titling.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/titling.source.tar.xz

Name: texlive-titling
License: LPPL
Summary: Control over the typesetting of the \maketitle command
Version: %{tl_version}
Release: %{tl_noarch_release}.2.1d.svn15878%{?dist}
BuildArch: noarch
