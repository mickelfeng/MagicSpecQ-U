...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/doi.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/doi.doc.tar.xz
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/doi/doi.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/doi/README
