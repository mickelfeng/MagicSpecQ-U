...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/alg.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/alg.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/alg.source.tar.xz

Name: texlive-alg
License: LPPL
Summary: LaTeX environments for typesetting algorithms
Version: %{tl_version}
Release: %{tl_noarch_release}.2001_03_13.svn15878%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Provides: tex(alg.sty)
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/alg/alg.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/alg/readme.txt
