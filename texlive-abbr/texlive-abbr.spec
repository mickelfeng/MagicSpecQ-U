...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/abbr.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/abbr.doc.tar.xz
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/generic/abbr/abbr.tex

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/generic/abbr/README
