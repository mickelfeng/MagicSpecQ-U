...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dviasm.tar.xz
...
Requires: texlive-dviasm-bin = %{tl_version}
...
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/scripts/dviasm/dviasm.py
