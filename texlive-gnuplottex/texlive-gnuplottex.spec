...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gnuplottex.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gnuplottex.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gnuplottex.source.tar.xz

Name: texlive-gnuplottex
License: GPL+
Summary: Embed Gnuplot commands in LaTeX documents
Version: %{tl_version}
Release: %{tl_noarch_release}.0.4.2.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/tex/latex/gnuplottex/gnuplottex.sty

%files doc
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/doc/latex/gnuplottex/README
%{_texdir}/texmf-dist/doc/latex/gnuplottex/example-pdf.tex
%{_texdir}/texmf-dist/doc/latex/gnuplottex/gnuplottex.pdf
%{_texdir}/texmf-dist/doc/latex/gnuplottex/gpl.txt
