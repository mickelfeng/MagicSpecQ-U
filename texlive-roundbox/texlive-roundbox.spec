...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/roundbox.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/roundbox.doc.tar.xz

Name: texlive-roundbox
License: LPPL
Summary: Round boxes in LaTeX
Version: %{tl_version}
Release: %{tl_noarch_release}.0.1.svn17896%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/roundbox/roundbox.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/roundbox/README
