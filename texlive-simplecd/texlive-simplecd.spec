...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/simplecd.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/simplecd.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/simplecd.source.tar.xz

Name: texlive-simplecd
License: LPPL
Summary: Simple CD, DVD covers for printing
Version: %{tl_version}
Release: %{tl_noarch_release}.1_0.svn19231%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.2.txt
%{_texdir}/texmf-dist/tex/latex/simplecd/simplecd.sty

%files doc
%defattr(-,root,root)
%doc lppl1.2.txt
%{_texdir}/texmf-dist/doc/latex/simplecd/README
%{_texdir}/texmf-dist/doc/latex/simplecd/simplecd.pdf
