...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ftcap.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ftcap.doc.tar.xz

Name: texlive-ftcap
License: GPL+
Summary: Allows \caption at the beginning of a table-environment
Version: %{tl_version}
Release: %{tl_noarch_release}.1.4.svn17275%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/tex/latex/ftcap/ftcap.sty

%files doc
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/doc/latex/ftcap/ftcap.pdf
%{_texdir}/texmf-dist/doc/latex/ftcap/ftcap.tex
