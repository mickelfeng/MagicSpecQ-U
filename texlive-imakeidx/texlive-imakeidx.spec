...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/imakeidx.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/imakeidx.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/imakeidx.source.tar.xz

Name: texlive-imakeidx
License: LPPL
Summary: A package for producing multiple indexes
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.svn19407%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/imakeidx/imakeidx.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/imakeidx/README
%{_texdir}/texmf-dist/doc/latex/imakeidx/imakeidx.pdf
