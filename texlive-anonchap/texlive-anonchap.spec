...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/anonchap.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/anonchap.doc.tar.xz

Name: texlive-anonchap
License: LPPL
Summary: Make chapters be typeset like sections
Version: %{tl_version}
Release: %{tl_noarch_release}.1.1a.svn17049%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/anonchap/anonchap.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/anonchap/anonchap.pdf
%{_texdir}/texmf-dist/doc/latex/anonchap/anonchap.tex
