...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/fancypar.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/fancypar.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/fancypar.source.tar.xz

Name: texlive-fancypar
License: LPPL
Summary: Decoration of individual paragraphs
Version: %{tl_version}
Release: %{tl_noarch_release}.1.1.svn18018%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/fancypar/fancypar.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/fancypar/README
%{_texdir}/texmf-dist/doc/latex/fancypar/fancypar.pdf
