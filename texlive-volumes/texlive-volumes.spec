...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/volumes.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/volumes.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/volumes.source.tar.xz
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/volumes/nowtoaux.sty
%{_texdir}/texmf-dist/tex/latex/volumes/volumes.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/volumes/README
%{_texdir}/texmf-dist/doc/latex/volumes/volumes.pdf
