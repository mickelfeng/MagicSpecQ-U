...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/spverbatim.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/spverbatim.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/spverbatim.source.tar.xz

Name: texlive-spverbatim
License: LPPL
Summary: Allow line breaks within \verb and verbatim output
Version: %{tl_version}
Release: %{tl_noarch_release}.v1.0.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/spverbatim/spverbatim.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/spverbatim/README
%{_texdir}/texmf-dist/doc/latex/spverbatim/spverbatim.pdf
