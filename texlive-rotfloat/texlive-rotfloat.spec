...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/rotfloat.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/rotfloat.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/rotfloat.source.tar.xz

Name: texlive-rotfloat
License: LPPL
Summary: Rotate floats
Version: %{tl_version}
Release: %{tl_noarch_release}.1.2.svn18292%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/rotfloat/rotfloat.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/rotfloat/examples.tex
%{_texdir}/texmf-dist/doc/latex/rotfloat/rotfloat.pdf
