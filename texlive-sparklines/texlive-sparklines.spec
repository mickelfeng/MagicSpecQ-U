...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/sparklines.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/sparklines.doc.tar.xz

Name: texlive-sparklines
License: LPPL
Summary: Drawing sparklines: intense, simple, wordlike graphics
Version: %{tl_version}
Release: %{tl_noarch_release}.1.5.svn16131%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/sparklines/sparklines.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/sparklines/README
%{_texdir}/texmf-dist/doc/latex/sparklines/sparklines.pdf
%{_texdir}/texmf-dist/doc/latex/sparklines/sparklines.tex
