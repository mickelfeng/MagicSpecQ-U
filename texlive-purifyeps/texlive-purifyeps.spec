...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/purifyeps.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/purifyeps.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/purifyeps.doc.tar.xz

Name: texlive-purifyeps
License: LPPL
Summary: Make EPS work with both LaTeX/dvips and pdfLaTeX
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0a.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-purifyeps-bin = %{tl_version}
...
%package doc
Summary: Documentation for purifyeps
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0a.svn18835%{?dist}
Requires: texlive-base = %{tl_version}
BuildArch: noarch
...
%{_texdir}/texmf-dist/scripts/purifyeps/purifyeps

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/support/purifyeps/README
