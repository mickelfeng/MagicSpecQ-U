...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/tokenizer.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/tokenizer.doc.tar.xz

Name: texlive-tokenizer
License: LPPL
Summary: A tokenizer
Version: %{tl_version}
Release: %{tl_noarch_release}.1.1.0.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/tokenizer/tokenizer.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/tokenizer/tokenizer.pdf
%{_texdir}/texmf-dist/doc/latex/tokenizer/tokenizer.tex
