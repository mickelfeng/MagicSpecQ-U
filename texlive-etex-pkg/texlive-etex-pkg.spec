...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/etex-pkg.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/etex-pkg.doc.tar.xz
...
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/tex/latex/etex-pkg/etex.sty

%files doc
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/doc/latex/etex-pkg/README
