...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/context-ruby.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/context-ruby.doc.tar.xz

Name: texlive-context-ruby
License: Public Domain
Summary: Ruby annotations in ConTeXt
Version: %{tl_version}
Release: %{tl_noarch_release}.svn16847%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/context/third/ruby/t-ruby.tex

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/context/third/ruby/README
