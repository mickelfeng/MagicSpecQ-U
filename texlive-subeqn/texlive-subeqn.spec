...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/subeqn.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/subeqn.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/subeqn.source.tar.xz

Name: texlive-subeqn
License: LPPL
Summary: Package for subequation numbering
Version: %{tl_version}
Release: %{tl_noarch_release}.2.0b.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/subeqn/subeqn.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/subeqn/manifest.txt
%{_texdir}/texmf-dist/doc/latex/subeqn/subeqn.pdf
%{_texdir}/texmf-dist/doc/latex/subeqn/subeqn.tex
