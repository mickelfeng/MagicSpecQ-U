...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/idxlayout.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/idxlayout.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/idxlayout.source.tar.xz

Name: texlive-idxlayout
License: LPPL
Summary: Configurable index layout, responsive to KOMA-Script and memoir
Version: %{tl_version}
Release: %{tl_noarch_release}.0.4c.svn19194%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/idxlayout/idxlayout.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/idxlayout/README
%{_texdir}/texmf-dist/doc/latex/idxlayout/idxlayout.pdf
