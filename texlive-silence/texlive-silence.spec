...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/silence.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/silence.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/silence.source.tar.xz

Name: texlive-silence
License: LPPL
Summary: Selective filtering of error messages and warnings
Version: %{tl_version}
Release: %{tl_noarch_release}.1.3.svn17242%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/silence/silence.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/silence/README
%{_texdir}/texmf-dist/doc/latex/silence/silence-doc.pdf
