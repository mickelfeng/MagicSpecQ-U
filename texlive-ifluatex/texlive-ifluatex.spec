...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ifluatex.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ifluatex.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ifluatex.source.tar.xz

Name: texlive-ifluatex
License: LPPL
Summary: Provides the \ifluatex switch
Version: %{tl_version}
Release: %{tl_noarch_release}.1.3.svn18100%{?dist}
BuildArch: noarch
