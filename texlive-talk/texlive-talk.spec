...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/talk.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/talk.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/talk.source.tar.xz
...
Provides: tex(sidebars.sty)
Provides: tex(talk.sty)
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/talk/sidebars.sty
%{_texdir}/texmf-dist/tex/latex/talk/talk.cls

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/talk/README
%{_texdir}/texmf-dist/doc/latex/talk/example.tex
%{_texdir}/texmf-dist/doc/latex/talk/talkdoc.pdf
%{_texdir}/texmf-dist/doc/latex/talk/talkdoc.tex
