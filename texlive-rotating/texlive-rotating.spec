...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/rotating.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/rotating.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/rotating.source.tar.xz

Name: texlive-rotating
License: LPPL
Summary: Rotation tools, including rotated full-page floats
Version: %{tl_version}
Release: %{tl_noarch_release}.2.16b.svn16832%{?dist}
BuildArch: noarch
...
%package doc
Summary: Documentation for rotating
Version: %{tl_version}
Release: %{tl_noarch_release}.2.16b.svn16832%{?dist}
Requires: texlive-base = %{tl_version}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/rotating/rotating.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/rotating/README
%{_texdir}/texmf-dist/doc/latex/rotating/cat.eps
%{_texdir}/texmf-dist/doc/latex/rotating/examples.tex
%{_texdir}/texmf-dist/doc/latex/rotating/rotating.pdf
