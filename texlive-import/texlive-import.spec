...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/import.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/import.doc.tar.xz

Name: texlive-import
License: Public Domain
Summary: Establish input relative to a directory
Version: %{tl_version}
Release: %{tl_noarch_release}.5.1.svn17361%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/import/import.sty

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/latex/import/import.pdf
%{_texdir}/texmf-dist/doc/latex/import/import.tex
