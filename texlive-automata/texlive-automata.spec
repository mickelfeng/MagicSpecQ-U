...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/automata.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/automata.doc.tar.xz
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/metapost/automata/automata.mp

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/metapost/automata/README
%{_texdir}/texmf-dist/doc/metapost/automata/example.mp
%{_texdir}/texmf-dist/doc/metapost/automata/example.pdf
%{_texdir}/texmf-dist/doc/metapost/automata/example.tex
