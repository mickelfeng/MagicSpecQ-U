...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/listing.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/listing.doc.tar.xz

Name: texlive-listing
License: LPPL
Summary: Produce formatted program listings
Version: %{tl_version}
Release: %{tl_noarch_release}.1.2.svn17373%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/listing/listing.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/listing/listing.pdf
%{_texdir}/texmf-dist/doc/latex/listing/listing.tex
