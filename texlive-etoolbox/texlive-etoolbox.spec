...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/etoolbox.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/etoolbox.doc.tar.xz

Name: texlive-etoolbox
License: LPPL
Summary: Tool-box for LaTeX programmers using e-TeX
Version: %{tl_version}
Release: %{tl_noarch_release}.1.9.svn17791%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/etoolbox/etoolbox.def
%{_texdir}/texmf-dist/tex/latex/etoolbox/etoolbox.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/etoolbox/README
%{_texdir}/texmf-dist/doc/latex/etoolbox/etoolbox.pdf
%{_texdir}/texmf-dist/doc/latex/etoolbox/etoolbox.tex
