...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/tex.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/tex.doc.tar.xz

Name: texlive-tex
License: Knuth
Summary: A sophisticated typesetting engine
Version: %{tl_version}
Release: %{tl_noarch_release}.3.1415926.svn18835%{?dist}
BuildArch: noarch
...
Requires: texlive-tex-bin = %{tl_version}
...
sed -i 's/^\#\!\ tex/tex tex - tex.ini/' %{_texdir}/texmf/web2c/fmtutil.cnf
touch /var/run/texlive/run-fmtutil
:

%postun
if [ $1 == 0 ]; then
  sed -i 's/^tex/\#\!\ tex/' %{_texdir}/texmf/web2c/fmtutil.cnf
