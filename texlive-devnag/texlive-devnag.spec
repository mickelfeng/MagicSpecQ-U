...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/devnag.tar.xz

Name: texlive-devnag
License: GPL+
Summary: Typeset Devanagari
Version: %{tl_version}
Release: %{tl_noarch_release}.2.15.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires: texlive-devnag-bin = %{tl_version}
