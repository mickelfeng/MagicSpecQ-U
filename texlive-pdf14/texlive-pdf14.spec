...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/pdf14.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/pdf14.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/pdf14.source.tar.xz

Name: texlive-pdf14
License: LPPL
Summary: Restore PDF 1.4 to a TeX live 2010 format
Version: %{tl_version}
Release: %{tl_noarch_release}.0.1.svn17583%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/pdf14/pdf14.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/pdf14/README
%{_texdir}/texmf-dist/doc/latex/pdf14/pdf14.pdf
%{_texdir}/texmf-dist/doc/latex/pdf14/test-pdf14.tex
