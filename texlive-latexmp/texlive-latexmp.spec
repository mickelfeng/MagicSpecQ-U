...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/latexmp.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/latexmp.doc.tar.xz

Name: texlive-latexmp
License: Public Domain
Summary: Interface for LaTeX-based typesetting in MetaPost
Version: %{tl_version}
Release: %{tl_noarch_release}.1.2.1.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/metapost/latexmp/latexmp.mp

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/metapost/latexmp/README
%{_texdir}/texmf-dist/doc/metapost/latexmp/latexmp.pdf
