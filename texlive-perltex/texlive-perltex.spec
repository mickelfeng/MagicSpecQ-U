...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/perltex.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/perltex.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/perltex.doc.tar.xz
Source3: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/perltex.source.tar.xz

Name: texlive-perltex
License: LPPL
Summary: Define LaTeX macros in terms of Perl code
Version: %{tl_version}
Release: %{tl_noarch_release}.2.0.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-perltex-bin = %{tl_version}
Provides: tex(perltex.sty)
Provides: tetex-perltex = %{tl_version}
Obsoletes: tetex-perltex < %{tl_version}
...
%package doc
Summary: Documentation for perltex
Version: %{tl_version}
Release: %{tl_noarch_release}.2.0.svn18835%{?dist}
Requires: texlive-base = %{tl_version}
BuildArch: noarch
...
%{_texdir}/texmf-dist/scripts/perltex/perltex.pl
%{_texdir}/texmf-dist/tex/latex/perltex/perltex.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/perltex/README
%{_texdir}/texmf-dist/doc/latex/perltex/example.tex
%{_texdir}/texmf-dist/doc/latex/perltex/perltex.pdf
