...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/de-macro.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/de-macro.doc.tar.xz

Name: texlive-de-macro
License: Freely redistributable without restriction
Summary: Expand private macros in a document
Version: %{tl_version}
Release: %{tl_noarch_release}.1.3.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-de-macro-bin = %{tl_version}
...
%package doc
Summary: Documentation for de-macro
Version: %{tl_version}
Release: %{tl_noarch_release}.1.3.svn18835%{?dist}
Requires: texlive-base = %{tl_version}
BuildArch: noarch
...
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/scripts/de-macro/de-macro

%files doc
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/doc/support/de-macro/README
%{_texdir}/texmf-dist/doc/support/de-macro/user-guide.pdf
%{_texdir}/texmf-dist/doc/support/de-macro/user-guide.tex
