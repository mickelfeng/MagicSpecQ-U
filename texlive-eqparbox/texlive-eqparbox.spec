...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/eqparbox.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/eqparbox.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/eqparbox.source.tar.xz

Name: texlive-eqparbox
License: LPPL
Summary: Create equal-widthed parboxes
Version: %{tl_version}
Release: %{tl_noarch_release}.3.1.svn16589%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/eqparbox/eqparbox.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/eqparbox/README
%{_texdir}/texmf-dist/doc/latex/eqparbox/eqparbox.pdf
