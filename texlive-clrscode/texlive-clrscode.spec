...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/clrscode.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/clrscode.doc.tar.xz

Name: texlive-clrscode
License: LPPL
Summary: Typesets pseudocode as in Introduction to Algorithms
Version: %{tl_version}
Release: %{tl_noarch_release}.1.7.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/clrscode/clrscode.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/clrscode/README
%{_texdir}/texmf-dist/doc/latex/clrscode/clrscode.pdf
