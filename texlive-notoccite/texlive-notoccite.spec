...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/notoccite.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/notoccite.doc.tar.xz

Name: texlive-notoccite
License: Public Domain
Summary: Prevent trouble from citations in table of contents, etc
Version: %{tl_version}
Release: %{tl_noarch_release}.svn18129%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/notoccite/notoccite.sty

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/latex/notoccite/notoccite.pdf
%{_texdir}/texmf-dist/doc/latex/notoccite/notoccite.tex
