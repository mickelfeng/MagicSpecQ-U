...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/vpe.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/vpe.doc.tar.xz

Name: texlive-vpe
License: LPPL
Summary: Source specials for PDF output
Version: %{tl_version}
Release: %{tl_noarch_release}.0.1.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-vpe-bin = %{tl_version}
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/scripts/vpe/vpe.pl
%{_texdir}/texmf-dist/tex/latex/vpe/vpe.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/vpe/vpe.txt
