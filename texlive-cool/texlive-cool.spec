...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/cool.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/cool.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/cool.source.tar.xz

Name: texlive-cool
License: LGPLv2+
Summary: COntent-Oriented LaTeX
Version: %{tl_version}
Release: %{tl_noarch_release}.1.35.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lgpl.txt
%{_texdir}/texmf-dist/tex/latex/cool/cool.sty

%files doc
%defattr(-,root,root)
%doc lgpl.txt
%{_texdir}/texmf-dist/doc/latex/cool/Content_LaTeX_Package_Demo.pdf
%{_texdir}/texmf-dist/doc/latex/cool/Content_LaTeX_Package_Demo.tex
%{_texdir}/texmf-dist/doc/latex/cool/README
%{_texdir}/texmf-dist/doc/latex/cool/cool.pdf
