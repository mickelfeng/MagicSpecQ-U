...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/hypernat.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/hypernat.doc.tar.xz

Name: texlive-hypernat
License: GPL+
Summary: Allow hyperref and natbib to work together
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0b.svn17358%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/tex/latex/hypernat/hypernat.sty

%files doc
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/doc/latex/hypernat/hypernat.pdf
%{_texdir}/texmf-dist/doc/latex/hypernat/hypernat.tex
