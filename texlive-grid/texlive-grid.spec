...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/grid.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/grid.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/grid.source.tar.xz
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/grid/grid.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/grid/README
%{_texdir}/texmf-dist/doc/latex/grid/grid.pdf
%{_texdir}/texmf-dist/doc/latex/grid/grid.tex
%{_texdir}/texmf-dist/doc/latex/grid/manifest.txt
%{_texdir}/texmf-dist/doc/latex/grid/rvdtx.sty
