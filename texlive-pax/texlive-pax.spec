...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/pax.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/pax.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/pax.source.tar.xz

Name: texlive-pax
License: Freely redistributable without restriction
Summary: Extract and reinsert PDF annotations with pdfTeX
Version: %{tl_version}
Release: %{tl_noarch_release}.v0.1i.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-pax-bin = %{tl_version}
...
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/scripts/pax/pax.jar
%{_texdir}/texmf-dist/scripts/pax/pdfannotextractor.pl
%{_texdir}/texmf-dist/tex/latex/pax/pax.sty

%files doc
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/doc/latex/pax/README
