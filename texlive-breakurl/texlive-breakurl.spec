...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/breakurl.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/breakurl.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/breakurl.source.tar.xz

Name: texlive-breakurl
License: LPPL
Summary: Line-breakable \url-like links in hyperref when compiling via dvips/ps2pdf
Version: %{tl_version}
Release: %{tl_noarch_release}.1.30.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/breakurl/breakurl.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/breakurl/README
%{_texdir}/texmf-dist/doc/latex/breakurl/breakurl.pdf
