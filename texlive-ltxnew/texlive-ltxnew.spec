...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ltxnew.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ltxnew.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ltxnew.source.tar.xz

Name: texlive-ltxnew
License: LPPL
Summary: A simple means of creating commands
Version: %{tl_version}
Release: %{tl_noarch_release}.1.2.svn17908%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/ltxnew/ltxnew.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/ltxnew/README
%{_texdir}/texmf-dist/doc/latex/ltxnew/ltxnew.pdf
