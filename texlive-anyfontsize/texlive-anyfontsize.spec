...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/anyfontsize.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/anyfontsize.doc.tar.xz

Name: texlive-anyfontsize
License: LPPL
Summary: Select any font size in LaTeX
Version: %{tl_version}
Release: %{tl_noarch_release}.svn17050%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/anyfontsize/anyfontsize.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/anyfontsize/README
%{_texdir}/texmf-dist/doc/latex/anyfontsize/anyfontsize.pdf
%{_texdir}/texmf-dist/doc/latex/anyfontsize/anyfontsize.tex
