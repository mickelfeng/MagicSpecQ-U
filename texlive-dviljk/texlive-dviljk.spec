...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dviljk.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dviljk.doc.tar.xz

Name: texlive-dviljk
License: GPL+
Summary: DVI to Laserjet output
Version: %{tl_version}
Release: %{tl_noarch_release}.2.6p4.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-dviljk-bin = %{tl_version}
