...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ebezier.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ebezier.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ebezier.source.tar.xz

Name: texlive-ebezier
License: LPPL
Summary: Device independent picture environment enhancement
Version: %{tl_version}
Release: %{tl_noarch_release}.4.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/ebezier/ebezier.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/ebezier/ebezier.pdf
