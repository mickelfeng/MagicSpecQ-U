...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/newverbs.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/newverbs.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/newverbs.source.tar.xz

Name: texlive-newverbs
License: LPPL
Summary: Define new versions of \verb, including short verb versions
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.svn17721%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/newverbs/newverbs.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/newverbs/README
%{_texdir}/texmf-dist/doc/latex/newverbs/newverbs.pdf
