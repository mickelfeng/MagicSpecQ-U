...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dcpic.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dcpic.doc.tar.xz

Name: texlive-dcpic
License: LPPL
Summary: Commutative diagrams in a LaTeX and TeX documents
Version: %{tl_version}
Release: %{tl_noarch_release}.4.3.2.svn19440%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/generic/dcpic/dcpic.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/generic/dcpic/README
%{_texdir}/texmf-dist/doc/generic/dcpic/README.TEXLIVE
%{_texdir}/texmf-dist/doc/generic/dcpic/examples.tex
