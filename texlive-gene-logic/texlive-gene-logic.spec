...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gene-logic.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gene-logic.doc.tar.xz
...
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/tex/latex/gene-logic/gn-logic14.sty

%files doc
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/doc/latex/gene-logic/gn-logic14.pdf
%{_texdir}/texmf-dist/doc/latex/gene-logic/gn-logic14.tex
