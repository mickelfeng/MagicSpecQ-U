...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/thumbpdf.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/thumbpdf.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/thumbpdf.doc.tar.xz

Name: texlive-thumbpdf
License: LPPL
Summary: Thumbnails for pdfTeX and dvips/ps2pdf
Version: %{tl_version}
Release: %{tl_noarch_release}.3.11.svn19315%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-thumbpdf-bin = %{tl_version}
...
%package doc
Summary: Documentation for thumbpdf
Version: %{tl_version}
Release: %{tl_noarch_release}.3.11.svn19315%{?dist}
Requires: texlive-base = %{tl_version}
BuildArch: noarch
...
%{_texdir}/texmf-dist/scripts/thumbpdf/thumbpdf.pl
%{_texdir}/texmf-dist/tex/generic/thumbpdf/thumbpdf.sty
%{_texdir}/texmf-dist/tex/generic/thumbpdf/thumbpdf.tex

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/generic/thumbpdf/readme.txt
