...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/float.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/float.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/float.source.tar.xz

Name: texlive-float
License: LPPL
Summary: Improved interface for floating objects
Version: %{tl_version}
Release: %{tl_noarch_release}.1.3d.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/float/float.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/float/README
%{_texdir}/texmf-dist/doc/latex/float/float.pdf
