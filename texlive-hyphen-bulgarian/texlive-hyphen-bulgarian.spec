...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/hyphen-bulgarian.tar.xz

Name: texlive-hyphen-bulgarian
License: LPPL
Summary: hyphen-bulgarian package
Version: %{tl_version}
...
%postun
if [ $1 == 0 ]; then
  sed -i '/bulgarian loadhyph-bg.tex/d' %{_texdir}/texmf/tex/generic/config/language.dat
  sed -i '/\\addlanguage{bulgarian}{loadhyph-bg.tex}{}{2}{2}/d' %{_texdir}/texmf/tex/generic/config/language.def
