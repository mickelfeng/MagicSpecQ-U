...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/randtext.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/randtext.doc.tar.xz
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/randtext/randtext.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/randtext/README
