...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/notes2bib.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/notes2bib.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/notes2bib.source.tar.xz

Name: texlive-notes2bib
License: LPPL
Summary: Integrating notes into the bibliography
Version: %{tl_version}
Release: %{tl_noarch_release}.2.0c.svn17665%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/notes2bib/notes2bib.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/notes2bib/README
%{_texdir}/texmf-dist/doc/latex/notes2bib/notes2bib.pdf
