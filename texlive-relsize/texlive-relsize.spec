...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/relsize.tar.xz

Name: texlive-relsize
License: Public Domain
Summary: Set the font size relative to the current font size
Version: %{tl_version}
Release: %{tl_noarch_release}.3.1.svn16203%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/relsize/relsize.sty
