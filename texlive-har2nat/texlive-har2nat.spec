...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/har2nat.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/har2nat.doc.tar.xz

Name: texlive-har2nat
License: LPPL
Summary: Replace the harvard package with natbib
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.svn17356%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/har2nat/har2nat.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/har2nat/README
%{_texdir}/texmf-dist/doc/latex/har2nat/har2nat.pdf
%{_texdir}/texmf-dist/doc/latex/har2nat/har2nat.tex
