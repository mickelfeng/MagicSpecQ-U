...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/mylatexformat.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/mylatexformat.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/mylatexformat.source.tar.xz

Name: texlive-mylatexformat
License: LPPL
Summary: Build a format based on the preamble of a LaTeX file
Version: %{tl_version}
Release: %{tl_noarch_release}.2.0.svn18899%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/mylatexformat/mylatexformat.ltx

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/mylatexformat/README
%{_texdir}/texmf-dist/doc/latex/mylatexformat/mylatexformat.pdf
