...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/chapterfolder.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/chapterfolder.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/chapterfolder.source.tar.xz

Name: texlive-chapterfolder
License: LPPL
Summary: Package for working with complicated folder structures
Version: %{tl_version}
Release: %{tl_noarch_release}.2.0.1.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/chapterfolder/chapterfolder.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/chapterfolder/chapterfolder.pdf
