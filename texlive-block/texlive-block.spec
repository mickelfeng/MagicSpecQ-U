...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/block.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/block.doc.tar.xz

Name: texlive-block
License: Public Domain
Summary: A block letter style for the letter class
Version: %{tl_version}
Release: %{tl_noarch_release}.svn17209%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/block/block.sty

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/latex/block/block.pdf
%{_texdir}/texmf-dist/doc/latex/block/block.tex
