...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/crossword.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/crossword.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/crossword.source.tar.xz

Name: texlive-crossword
License: Freely redistributable without restriction
Summary: Typeset crossword puzzles
Version: %{tl_version}
Release: %{tl_noarch_release}.1.8.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/tex/latex/crossword/cwpuzzle.sty

%files doc
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/doc/latex/crossword/README
%{_texdir}/texmf-dist/doc/latex/crossword/cwpuzzle.pdf
