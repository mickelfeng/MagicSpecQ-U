...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/curves.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/curves.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/curves.source.tar.xz

Name: texlive-curves
License: LPPL
Summary: Curves for LaTeX picture environment
Version: %{tl_version}
Release: %{tl_noarch_release}.1.53.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/curves/curves.sty
%{_texdir}/texmf-dist/tex/latex/curves/curvesls.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/curves/README
%{_texdir}/texmf-dist/doc/latex/curves/curves.pdf
%{_texdir}/texmf-dist/doc/latex/curves/latex2pdf
