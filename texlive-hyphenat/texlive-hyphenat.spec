...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/hyphenat.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/hyphenat.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/hyphenat.source.tar.xz

Name: texlive-hyphenat
License: LPPL
Summary: Disable/enable hypenation
Version: %{tl_version}
Release: %{tl_noarch_release}.2.3c.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/hyphenat/hyphenat.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/hyphenat/README
%{_texdir}/texmf-dist/doc/latex/hyphenat/hyphenat.pdf
