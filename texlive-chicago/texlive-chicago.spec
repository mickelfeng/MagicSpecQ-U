...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/chicago.tar.xz
...
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/bibtex/bst/chicago/chicago.bst
%{_texdir}/texmf-dist/tex/latex/chicago/chicago.sty
