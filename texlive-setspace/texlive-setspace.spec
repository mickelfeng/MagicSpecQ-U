...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/setspace.tar.xz

Name: texlive-setspace
License: Public Domain
Summary: Set space between lines
Version: %{tl_version}
Release: %{tl_noarch_release}.6.7.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/setspace/setspace.sty
