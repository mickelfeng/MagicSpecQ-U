...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/cases.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/cases.doc.tar.xz

Name: texlive-cases
License: Public Domain
Summary: Numbered cases environment
Version: %{tl_version}
Release: %{tl_noarch_release}.2.5.svn17123%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/cases/cases.sty

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/latex/cases/cases.pdf
%{_texdir}/texmf-dist/doc/latex/cases/cases.tex
