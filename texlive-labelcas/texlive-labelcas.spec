...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/labelcas.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/labelcas.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/labelcas.source.tar.xz

Name: texlive-labelcas
License: LPPL
Summary: Check the existence of labels, and fork accordingly
Version: %{tl_version}
Release: %{tl_noarch_release}.1.12.svn15878%{?dist}
BuildArch: noarch
...
%package doc
Summary: Documentation for labelcas
Version: %{tl_version}
Release: %{tl_noarch_release}.1.12.svn15878%{?dist}
Requires: texlive-base = %{tl_version}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/labelcas/labelcas.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/labelcas/README
%{_texdir}/texmf-dist/doc/latex/labelcas/labelcas.pdf
