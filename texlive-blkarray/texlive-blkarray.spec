...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/blkarray.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/blkarray.doc.tar.xz

Name: texlive-blkarray
License: LPPL
Summary: Extended array and tabular
Version: %{tl_version}
Release: %{tl_noarch_release}.svn17089%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/blkarray/blkarray.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/blkarray/README
%{_texdir}/texmf-dist/doc/latex/blkarray/blkarray.pdf
%{_texdir}/texmf-dist/doc/latex/blkarray/blkarray.tex
