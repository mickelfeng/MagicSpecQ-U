...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/titleref.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/titleref.doc.tar.xz

Name: texlive-titleref
License: Public Domain
Summary: A "\titleref" command to cross-reference section titles
Version: %{tl_version}
Release: %{tl_noarch_release}.2.0.svn18729%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/titleref/titleref.sty

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/latex/titleref/miscdoc.sty
%{_texdir}/texmf-dist/doc/latex/titleref/titleref.pdf
%{_texdir}/texmf-dist/doc/latex/titleref/titleref.tex
