...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/boolexpr.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/boolexpr.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/boolexpr.source.tar.xz

Name: texlive-boolexpr
License: LPPL
Summary: A boolean expression evaluator and a switch command
Version: %{tl_version}
Release: %{tl_noarch_release}.3.14.svn17830%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/boolexpr/boolexpr.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/boolexpr/README
%{_texdir}/texmf-dist/doc/latex/boolexpr/boolexpr.pdf
