...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/hyphen-ukrainian.tar.xz

Name: texlive-hyphen-ukrainian
License: LPPL
Summary: hyphen-ukrainian package
Version: %{tl_version}
...
%postun
if [ $1 == 0 ]; then
  sed -i '/ukrainian loadhyph-uk.tex/d' %{_texdir}/texmf/tex/generic/config/language.dat
  sed -i '/\\addlanguage{ukrainian}{loadhyph-uk.tex}{}{2}{2}/d' %{_texdir}/texmf/tex/generic/config/language.def
