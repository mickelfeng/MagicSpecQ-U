...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ltxindex.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ltxindex.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ltxindex.source.tar.xz

Name: texlive-ltxindex
License: GPL+
Summary: A LaTeX package to typeset indices with GNU's Texindex
Version: %{tl_version}
Release: %{tl_noarch_release}.0.1c.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/tex/latex/ltxindex/ltxindex.sty

%files doc
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/doc/latex/ltxindex/README
%{_texdir}/texmf-dist/doc/latex/ltxindex/copying.txt
%{_texdir}/texmf-dist/doc/latex/ltxindex/ltxindex.pdf
