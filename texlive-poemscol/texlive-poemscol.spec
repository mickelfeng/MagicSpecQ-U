...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/poemscol.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/poemscol.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/poemscol.source.tar.xz

Name: texlive-poemscol
License: LPPL
Summary: Typesetting Critical Editions of Poetry
Version: %{tl_version}
Release: %{tl_noarch_release}.2.53.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/poemscol/poemscol.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/poemscol/README
%{_texdir}/texmf-dist/doc/latex/poemscol/poemscol.pdf
%{_texdir}/texmf-dist/doc/latex/poemscol/poemscolcheatsheet.pdf
