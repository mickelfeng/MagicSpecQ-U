...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/carlisle.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/carlisle.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/carlisle.source.tar.xz

Name: texlive-carlisle
License: LPPL
Summary: David Carlisle's small packages
Version: %{tl_version}
Release: %{tl_noarch_release}.svn18258%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/carlisle/dotlessj.sty
%{_texdir}/texmf-dist/tex/latex/carlisle/ltxtable.sty
%{_texdir}/texmf-dist/tex/latex/carlisle/mylatex.ltx
%{_texdir}/texmf-dist/tex/latex/carlisle/plain.sty
%{_texdir}/texmf-dist/tex/latex/carlisle/remreset.sty
%{_texdir}/texmf-dist/tex/latex/carlisle/scalefnt.sty
%{_texdir}/texmf-dist/tex/latex/carlisle/slashed.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/carlisle/README
%{_texdir}/texmf-dist/doc/latex/carlisle/ltx1.tex
%{_texdir}/texmf-dist/doc/latex/carlisle/ltxtable.pdf
