...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/rlepsf.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/rlepsf.doc.tar.xz

Name: texlive-rlepsf
License: LPPL
Summary: Rewrite labels in EPS graphics
Version: %{tl_version}
Release: %{tl_noarch_release}.svn19082%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/generic/rlepsf/rlepsf.tex

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/generic/rlepsf/read.me
%{_texdir}/texmf-dist/doc/generic/rlepsf/rlepsdoc.ps
