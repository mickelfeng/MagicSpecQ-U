...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/context-gnuplot.tar.xz
...
You probably also want to have the Gnuplot extension for the
package (though it's not yet part of official Gnuplot).
...
%{_texdir}/texmf-dist/tex/context/third/gnuplot/t-gnuplot.tex
