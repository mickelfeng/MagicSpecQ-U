...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/authorindex.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/authorindex.doc.tar.xz
...
Requires: texlive-authorindex-bin = %{tl_version}
...
%package doc
Summary: Documentation for authorindex
Version: %{tl_version}
Release: %{tl_noarch_release}.svn18835%{?dist}
Requires: texlive-base = %{tl_version}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/scripts/authorindex/authorindex
%{_texdir}/texmf-dist/tex/latex/authorindex/authorindex.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/authorindex/COPYING
%{_texdir}/texmf-dist/doc/latex/authorindex/NEWS
%{_texdir}/texmf-dist/doc/latex/authorindex/README
%{_texdir}/texmf-dist/doc/latex/authorindex/authorindex.pdf
%{_texdir}/texmf-dist/doc/latex/authorindex/authorindex.tex
