...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gmiflink.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/gmiflink.doc.tar.xz

Name: texlive-gmiflink
License: LPPL
Summary: Simplify usage of \hypertarget and \hyperlink
Version: %{tl_version}
Release: %{tl_noarch_release}.v0.97.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/gmiflink/gmiflink.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/gmiflink/README
%{_texdir}/texmf-dist/doc/latex/gmiflink/gmiflink.pdf
