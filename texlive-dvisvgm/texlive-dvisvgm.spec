...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dvisvgm.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dvisvgm.doc.tar.xz

Name: texlive-dvisvgm
License: GPL+
Summary: Converts DVI files to Scalable Vector Graphics format (SVG)
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.1.svn19536%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-dvisvgm-bin = %{tl_version}
...
successfully tested with both teTeX and MikTeX.
