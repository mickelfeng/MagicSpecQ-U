...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/esk.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/esk.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/esk.source.tar.xz

Name: texlive-esk
License: GPL+
Summary: Package to encapsulate Sketch files in LaTeX sources
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.svn18115%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/tex/latex/esk/esk.sty

%files doc
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/doc/latex/esk/COPYING
%{_texdir}/texmf-dist/doc/latex/esk/README
%{_texdir}/texmf-dist/doc/latex/esk/esk.pdf
%{_texdir}/texmf-dist/doc/latex/esk/eskman.pdf
