...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/minipage-marginpar.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/minipage-marginpar.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/minipage-marginpar.source.tar.xz

Name: texlive-minipage-marginpar
License: LPPL
Summary: Minipages with marginal notes
Version: %{tl_version}
Release: %{tl_noarch_release}.v0.2.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/minipage-marginpar/minipage-marginpar.sty
%{_texdir}/texmf-dist/tex/latex/minipage-marginpar/mpgmpar.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/minipage-marginpar/README
%{_texdir}/texmf-dist/doc/latex/minipage-marginpar/minipage-marginpar.pdf
