...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/nopageno.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/nopageno.doc.tar.xz

Name: texlive-nopageno
License: LPPL
Summary: No page numbers in LaTeX documents
Version: %{tl_version}
Release: %{tl_noarch_release}.svn18128%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/nopageno/nopageno.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/nopageno/nopageno.pdf
%{_texdir}/texmf-dist/doc/latex/nopageno/nopageno.tex
