...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/verbdef.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/verbdef.doc.tar.xz

Name: texlive-verbdef
License: LPPL
Summary: Define commands which expand to verbatim text
Version: %{tl_version}
Release: %{tl_noarch_release}.0.2.svn17177%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/verbdef/verbdef.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/verbdef/verbdef.pdf
%{_texdir}/texmf-dist/doc/latex/verbdef/verbdef.tex
