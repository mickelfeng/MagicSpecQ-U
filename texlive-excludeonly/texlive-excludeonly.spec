...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/excludeonly.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/excludeonly.doc.tar.xz

Name: texlive-excludeonly
License: Public Domain
Summary: Prevent files being \include-ed
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.svn17262%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/excludeonly/excludeonly.sty

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/latex/excludeonly/excludeonly.pdf
%{_texdir}/texmf-dist/doc/latex/excludeonly/excludeonly.tex
