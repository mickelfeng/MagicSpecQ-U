...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/booklet.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/booklet.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/booklet.source.tar.xz

Name: texlive-booklet
License: LPPL
Summary: Aids for printing simple booklets
Version: %{tl_version}
Release: %{tl_noarch_release}.0.7b.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/booklet/bkltprnt.sty
%{_texdir}/texmf-dist/tex/latex/booklet/booklet.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/booklet/README
%{_texdir}/texmf-dist/doc/latex/booklet/booklet.pdf
