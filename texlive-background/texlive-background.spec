...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/background.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/background.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/background.source.tar.xz

Name: texlive-background
License: LPPL
Summary: Placement of background material on pages of a document
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.svn19538%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/background/background.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/background/README
%{_texdir}/texmf-dist/doc/latex/background/background.pdf
