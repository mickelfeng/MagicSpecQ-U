...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/snapshot.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/snapshot.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/snapshot.source.tar.xz

Name: texlive-snapshot
License: LPPL
Summary: List the external dependencies of a LaTeX document
Version: %{tl_version}
Release: %{tl_noarch_release}.1.14.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/snapshot/snapshot.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/snapshot/snapshot.pdf
