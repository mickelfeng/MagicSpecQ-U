...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/colordoc.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/colordoc.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/colordoc.source.tar.xz

Name: texlive-colordoc
License: LPPL
Summary: Coloured syntax highlights in documentation
Version: %{tl_version}
Release: %{tl_noarch_release}.svn18270%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/colordoc/colordoc.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/colordoc/README
%{_texdir}/texmf-dist/doc/latex/colordoc/colordoc.pdf
