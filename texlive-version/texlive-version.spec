...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/version.tar.xz
...
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/tex/latex/version/version.sty
