...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/patchcmd.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/patchcmd.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/patchcmd.source.tar.xz
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/patchcmd/patchcmd.sty

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/latex/patchcmd/patchcmd.pdf
