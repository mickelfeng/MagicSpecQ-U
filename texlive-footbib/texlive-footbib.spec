...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/footbib.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/footbib.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/footbib.source.tar.xz

Name: texlive-footbib
License: LPPL
Summary: Bibliographic references as footnotes
Version: %{tl_version}
Release: %{tl_noarch_release}.2.0.7.svn17115%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/footbib/footbib.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/footbib/README
%{_texdir}/texmf-dist/doc/latex/footbib/footbib.pdf
