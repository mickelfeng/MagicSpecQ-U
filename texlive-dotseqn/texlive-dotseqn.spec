...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dotseqn.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dotseqn.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/dotseqn.source.tar.xz

Name: texlive-dotseqn
License: Freely redistributable without restriction
Summary: Flush left equations with dotted leaders to the numbers
Version: %{tl_version}
Release: %{tl_noarch_release}.1.1.svn17195%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/tex/latex/dotseqn/dotseqn.sty

%files doc
%defattr(-,root,root)
%doc other-free.txt
%{_texdir}/texmf-dist/doc/latex/dotseqn/dotseqn.pdf
%{_texdir}/texmf-dist/doc/latex/dotseqn/readme
