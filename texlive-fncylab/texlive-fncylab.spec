...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/fncylab.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/fncylab.doc.tar.xz

Name: texlive-fncylab
License: LPPL
Summary: Alter the format of \label references
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.svn17382%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/fncylab/fncylab.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/fncylab/fncylab-example.tex
%{_texdir}/texmf-dist/doc/latex/fncylab/fncylab.pdf
%{_texdir}/texmf-dist/doc/latex/fncylab/fncylab.tex
