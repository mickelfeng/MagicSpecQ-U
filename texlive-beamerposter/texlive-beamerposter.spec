...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/beamerposter.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/beamerposter.doc.tar.xz

Name: texlive-beamerposter
License: LPPL
Summary: Extend beamer and a0poster for custom sized posters
Version: %{tl_version}
Release: %{tl_noarch_release}.1.07.svn17066%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/beamerposter/beamerposter.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/beamerposter/README
%{_texdir}/texmf-dist/doc/latex/beamerposter/beamerposter.pdf
%{_texdir}/texmf-dist/doc/latex/beamerposter/beamerposter.tex
%{_texdir}/texmf-dist/doc/latex/beamerposter/example.tex
