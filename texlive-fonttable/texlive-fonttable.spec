...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/fonttable.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/fonttable.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/fonttable.source.tar.xz

Name: texlive-fonttable
License: LPPL
Summary: Print font tables from a LaTeX document
Version: %{tl_version}
Release: %{tl_noarch_release}.1.6.svn16111%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/fonttable/fonttable.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/fonttable/README
%{_texdir}/texmf-dist/doc/latex/fonttable/fonttable.pdf
