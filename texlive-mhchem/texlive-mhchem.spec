...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/mhchem.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/mhchem.doc.tar.xz

Name: texlive-mhchem
License: LPPL
Summary: Typeset chemical formulae/equations and Risk and Safety phrases
Version: %{tl_version}
Release: %{tl_noarch_release}.3.08.svn19018%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/mhchem/mhchem.sty
%{_texdir}/texmf-dist/tex/latex/mhchem/rsphrase.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/mhchem/legal.txt
%{_texdir}/texmf-dist/doc/latex/mhchem/mhchem.pdf
