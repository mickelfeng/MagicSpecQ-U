...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/getfiledate.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/getfiledate.doc.tar.xz

Name: texlive-getfiledate
License: LPPL
Summary: Find the date of last modification of a file
Version: %{tl_version}
Release: %{tl_noarch_release}.1.2.svn16189%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/getfiledate/getfiledate.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/getfiledate/README
%{_texdir}/texmf-dist/doc/latex/getfiledate/getfiledate-guide.pdf
%{_texdir}/texmf-dist/doc/latex/getfiledate/getfiledate-guide.tex
