...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/xdvi.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/xdvi.doc.tar.xz

Name: texlive-xdvi
License: Freely redistributable without restriction
Summary: A DVI previewer for the X Window System
Version: %{tl_version}
Release: %{tl_noarch_release}.22.84.16.svn18835%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Requires: texlive-xdvi-bin = %{tl_version}
...
%{_texdir}/texmf/xdvi/XDvi
%{_texdir}/texmf/xdvi/xdvi.cfg
%{_texdir}/texmf/xdvi/pixmap/toolbar.xpm
%{_texdir}/texmf/xdvi/pixmap/toolbar2.xpm
