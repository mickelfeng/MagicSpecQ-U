...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/pgfopts.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/pgfopts.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/pgfopts.source.tar.xz

Name: texlive-pgfopts
License: LPPL
Summary: LaTeX package options with pgfkeys
Version: %{tl_version}
Release: %{tl_noarch_release}.2.0.svn18072%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/tex/latex/pgfopts/pgfopts.sty

%files doc
%defattr(-,root,root)
%doc lppl1.3.txt
%{_texdir}/texmf-dist/doc/latex/pgfopts/README
%{_texdir}/texmf-dist/doc/latex/pgfopts/pgfopts.pdf
