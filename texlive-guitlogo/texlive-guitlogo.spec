...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/guitlogo.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/guitlogo.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/guitlogo.source.tar.xz

Name: texlive-guitlogo
License: LPPL
Summary: Macros for typesetting the GuIT logo
Version: %{tl_version}
Release: %{tl_noarch_release}.0.9.1.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/guitlogo/guit.cfg
%{_texdir}/texmf-dist/tex/latex/guitlogo/guit.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/guitlogo/README
%{_texdir}/texmf-dist/doc/latex/guitlogo/guit.pdf
%{_texdir}/texmf-dist/doc/latex/guitlogo/guittest.pdf
%{_texdir}/texmf-dist/doc/latex/guitlogo/guittest.tex
