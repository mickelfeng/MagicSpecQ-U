...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/boxhandler.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/boxhandler.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/boxhandler.source.tar.xz

Name: texlive-boxhandler
License: LPPL
Summary: Flexible Captioning and Deferred Box/List Printing
Version: %{tl_version}
Release: %{tl_noarch_release}.1.21.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/boxhandler/boxhandler.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/boxhandler/README
%{_texdir}/texmf-dist/doc/latex/boxhandler/boxhandler.pdf
