...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/texilikechaps.tar.xz

Name: texlive-texilikechaps
License: LPPL
Summary: Format chapters with a texi-like format
Version: %{tl_version}
Release: %{tl_noarch_release}.1.0.svn16752%{?dist}
BuildArch: noarch
Requires: texlive-base = %{tl_version}
Requires: texlive-kpathsea-bin = %{tl_version}
Requires(post,postun): texlive-kpathsea-bin = %{tl_version}
Provides: tex(texilikechaps.sty)
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/texilikechaps/texilikechaps.sty
