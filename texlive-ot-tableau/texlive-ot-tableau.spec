...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ot-tableau.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/ot-tableau.doc.tar.xz

Name: texlive-ot-tableau
License: LPPL
Summary: Optimality Theory tableaux in LaTeX
Version: %{tl_version}
Release: %{tl_noarch_release}.svn17829%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/ot-tableau/ot-tableau.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/ot-tableau/README
%{_texdir}/texmf-dist/doc/latex/ot-tableau/ot-tableau.pdf
%{_texdir}/texmf-dist/doc/latex/ot-tableau/ot-tableau.tex
