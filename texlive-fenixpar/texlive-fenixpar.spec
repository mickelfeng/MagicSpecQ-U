...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/fenixpar.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/fenixpar.doc.tar.xz

Name: texlive-fenixpar
License: LPPL
Summary: One-shot changes to token registers such as \everypar
Version: %{tl_version}
Release: %{tl_noarch_release}.0.91.svn18147%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/generic/fenixpar/fenixpar.sty
%{_texdir}/texmf-dist/tex/generic/fenixpar/fenixtok.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/generic/fenixpar/README
