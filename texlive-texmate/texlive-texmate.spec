...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/texmate.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/texmate.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/texmate.source.tar.xz

Name: texlive-texmate
License: LPPL
Summary: Comprehensive chess annotation in LaTeX
Version: %{tl_version}
Release: %{tl_noarch_release}.2.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/texmate/texmate.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/texmate/README
%{_texdir}/texmf-dist/doc/latex/texmate/texmate2manual.pdf
%{_texdir}/texmf-dist/doc/latex/texmate/texmate2manual.tex
