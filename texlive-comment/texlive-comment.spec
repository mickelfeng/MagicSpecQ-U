...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/comment.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/comment.doc.tar.xz

Name: texlive-comment
License: GPL+
Summary: Selectively include/excludes portions of text
Version: %{tl_version}
Release: %{tl_noarch_release}.3.6.svn17155%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/tex/latex/comment/comment.sty

%files doc
%defattr(-,root,root)
%doc gpl.txt
%{_texdir}/texmf-dist/doc/latex/comment/README
%{_texdir}/texmf-dist/doc/latex/comment/comm_latest.tex
%{_texdir}/texmf-dist/doc/latex/comment/comment.pdf
%{_texdir}/texmf-dist/doc/latex/comment/comment.tex
