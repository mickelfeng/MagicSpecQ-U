...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/here.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/here.doc.tar.xz

Name: texlive-here
License: Public Domain
Summary: Emulation of obsolete package for "here" floats
Version: %{tl_version}
Release: %{tl_noarch_release}.svn16135%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/tex/latex/here/here.sty

%files doc
%defattr(-,root,root)
%doc pd.txt
%{_texdir}/texmf-dist/doc/latex/here/README
