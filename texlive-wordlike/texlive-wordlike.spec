...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/wordlike.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/wordlike.doc.tar.xz
Source2: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/wordlike.source.tar.xz

Name: texlive-wordlike
License: LPPL
Summary: Simulating word processor layout
Version: %{tl_version}
Release: %{tl_noarch_release}.1.2b.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/wordlike/wordlike.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/wordlike/README
%{_texdir}/texmf-dist/doc/latex/wordlike/wordlike.pdf
