...
Source0: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/calctab.tar.xz
Source1: ftp://ftp.ctex.org/mirrors/texlive/tlpretest/archive/calctab.doc.tar.xz

Name: texlive-calctab
License: LPPL
Summary: Language for numeric tables
Version: %{tl_version}
Release: %{tl_noarch_release}.v0.6.1.svn15878%{?dist}
BuildArch: noarch
...
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/tex/latex/calctab/calctab.sty

%files doc
%defattr(-,root,root)
%doc lppl.txt
%{_texdir}/texmf-dist/doc/latex/calctab/README
%{_texdir}/texmf-dist/doc/latex/calctab/calctab_manual.pdf
%{_texdir}/texmf-dist/doc/latex/calctab/calctab_manual.tex
